( function( $ ) {
	var tinymceSettings = {
		...
		tinymce: {
			...
			language:"es",
			menubar:false,
			plugins:"anchor,wplink,charmap,colorpicker,hr,lists,paste,tabfocus,textcolor,wordpress,wpautoresize,wpeditimage,wpemoji,wpgallery,wptextpattern",
			...
			skin:"lightgray",
			theme:"modern",
			toolbar1:"link, bold,italic,underline,strikethrough,alignleft,aligncenter,justifyleft,alignright,alignjustify,justifycenter,justifyright,justifyfull,bullist,numlist,outdent,indent,cut,copy,paste,undo,redo,link,unlink,image,cleanup,help,code,hr,removeformat,formatselect,fontselect,fontsizeselect,styleselect,sub,sup,forecolor,backcolor,forecolorpicker,backcolorpicker,charmap,visualaid,anchor,newdocument,blockquote,separator",
