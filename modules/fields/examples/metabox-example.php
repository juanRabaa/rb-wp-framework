...
/*******************************************************************************
Example showing the use of the different fields inside a post metabox.
This will add metaboxes containing the fields to the post edition page.
You can see how single fields, groups and repeaters are implemented, and
how they work.
*******************************************************************************/
...
add_action( 'current_screen', function(){
	...
	if( $screen->id == 'post' ){
	    ...
	    new RB_Metabox('rb-test-single', array(
		...
		*****************************************************************************/
		...
		// SINGLES GROUP
		// =============================================================================
	    new RB_Metabox('rb-test-single-group', array(
		...
		*****************************************************************************/
	    ...
	    new RB_Metabox('rb-test-groups-group', array(
		...
		*****************************************************************************/
	    ...
	    new RB_Metabox('rb-test-repeaters-group', array(
		...
		*****************************************************************************/
		...
		// SINGLES REPEATER
		// =============================================================================
	    new RB_Metabox('rb-test-singles-repeater', array(
		...
		// GROUPS REPEATER
		// =============================================================================
	    new RB_Metabox('rb-test-groups-repeater', array(
		...
		// REPEATERS REPEATER
		// =============================================================================
	    new RB_Metabox('rb-test-repeaters-repeater', array(
